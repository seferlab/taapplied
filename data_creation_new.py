...
for etf in etfList:
    ...
    folders = ["./ETF/TrainData/", "./ETF/TestData/", "./ETF/Date/TrainDate/", "./ETF/Date/TestDate", "./ETF/Price/TrainPrice/", "./ETF/Price/TestPrice/"]
    for folder in folders:
        if not os.path.exists(folder):
            os.makedirs(folder)
    
    np.save(f"./ETF/TrainData/x_{etf}.npy", x_train)
    np.save(f"./ETF/TrainData/y_{etf}.npy", y_train)
    np.save(f"./ETF/TestData/x_{etf}.npy", x_test)
    np.save(f"./ETF/TestData/y_{etf}.npy", y_test)

    np.save(f"./ETF/Date/TrainDate/{etf}.npy", train_date)
    np.save(f"./ETF/Date/TestDate/{etf}.npy", test_date)
    np.save(f'./ETF/Price/TrainPrice/{etf}.npy', train_price)
    np.save(f'./ETF/Price/TestPrice/{etf}.npy', test_price)
